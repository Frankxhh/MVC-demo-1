...
})({"dtRgW":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
...
},{"./app1.css":"cNEhT","jquery":"bE6My","@parcel/transformer-js/src/esmodule-helpers.js":"ehJt5"}],"cNEhT":[function() {},{}],"bE6My":[function(require,module,exports) {
/*!
...
},{}],"ehJt5":[function(require,module,exports) {
...
var _jquery = require("jquery");
var _jqueryDefault = parcelHelpers.interopDefault(_jquery);
const $head = _jqueryDefault.default('#app2 .tab-bar');
const $body = _jqueryDefault.default('#app2 .tab-content');
$head.on('click', 'li', (e)=>{
    const $li = _jqueryDefault.default(e.currentTarget);
    $li.addClass('color').siblings().removeClass('color');
    const $index = $li.index();
    $body.children().eq($index).addClass('active').siblings().removeClass('active');
});
//默认就打开第一个
$head.children().eq(0).trigger('click');

},{"./app2.css":"2POXe","jquery":"bE6My","@parcel/transformer-js/src/esmodule-helpers.js":"ehJt5"}],"2POXe":[function() {},{}],"39DIW":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _app3Css = require("./app3.css");
var _jquery = require("jquery");
var _jqueryDefault = parcelHelpers.interopDefault(_jquery);
const $sq = _jqueryDefault.default('#app3 .square');
$sq.on('click', ()=>{
    $sq.toggleClass('active');
});

},{"./app3.css":"6afT9","jquery":"bE6My","@parcel/transformer-js/src/esmodule-helpers.js":"ehJt5"}],"6afT9":[function() {},{}],"jOilj":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _app4Css = require("./app4.css");
var _jquery = require("jquery");
var _jqueryDefault = parcelHelpers.interopDefault(_jquery);
const $cr = _jqueryDefault.default('#app4 .circle');
$cr.on('mousemove', ()=>{
    $cr.addClass('active');
});
$cr.on('mouseout', ()=>{
...
},{"./app4.css":"dmc4x","jquery":"bE6My","@parcel/transformer-js/src/esmodule-helpers.js":"ehJt5"}],"dmc4x":[function() {},{}]},["dtRgW","iJDgK"], "iJDgK", "parcelRequirea9bd")
